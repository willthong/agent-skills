---
name: to-prd
description: Turn the current conversation context into a PRD and save it as a Markdown file. Use when user wants to create a PRD from the current context.
---
...
1. Explore the repo to understand the current state of the codebase, if you haven't
   already. Use the project's domain glossary vocabulary throughout the PRD, and respect
...
3. Write the PRD using the template below, then save it locally. 
